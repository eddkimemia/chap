...
export default function AdminDashboard() {
  ...
  const statCards = [
    ...
    { title: 'Active Listings', value: stats?.newListings ?? 0, icon: List, color: 'bg-accent-orange', href: '/admin/listings' },
  ...
  return (
    <div className="space-y-6 lg:pl-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-navy tracking-tight">Admin Dashboard</h1>
                  ...
                  <CardContent className="p-5">
                    <div className="flex items-start justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-bold text-navy mt-1">{typeof stat.value === 'number' ? stat.value.toLocaleString() : stat.value}</p>
                      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        <Card className="rounded-2xl border-0 shadow-premium">
          <CardHeader className="pb-2">
            <CardTitle className="text-navy text-lg font-bold">Revenue Trend</CardTitle>
          </CardHeader>
          <CardContent>
            {loading ? (
        ...
        <Card className="rounded-2xl border-0 shadow-premium">
          <CardHeader className="pb-2">
            <CardTitle className="text-navy text-lg font-bold">New Listings</CardTitle>
          </CardHeader>
          <CardContent>
            {loading ? (
              <Skeleton className="h-[250px]" />
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        <Card className="rounded-2xl border-0 shadow-premium">
          <CardHeader>
            <CardTitle className="text-navy text-lg font-bold">Recent Activity</CardTitle>
          </CardHeader>
          <CardContent>
            {loading ? (
        ...
        <Card className="rounded-2xl border-0 shadow-premium">
          <CardHeader>
            <CardTitle className="text-navy text-lg font-bold">Quick Actions</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-2 gap-3">
              {[
                { label: 'Manage Users', icon: Users, href: '/admin/users', color: 'text-royal' },
                { label: 'Manage Listings', icon: List, href: '/admin/listings', color: 'text-accent-orange' },
