      ...
      <Card className="w-full max-w-md glass-card shadow-premium-xl relative z-10 rounded-3xl border-0">
        <CardContent className="p-8 sm:p-10">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button variant="outline" className="h-11 rounded-2xl border-slate-200 gap-2 text-sm" onClick={() => toast.info('Google login coming soon')}>
              <Chrome className="h-4 w-4" /> Google
            </Button>
            <Button variant="outline" className="h-11 rounded-2xl border-slate-200 gap-2 text-sm" onClick={() => toast.info('WhatsApp login coming soon')}>
