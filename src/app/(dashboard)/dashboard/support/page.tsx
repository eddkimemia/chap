                ...
                <CardContent className="p-5 space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <a href={`mailto:${process.env.NEXT_PUBLIC_SUPPORT_EMAIL || 'support@chap.co.ke'}`} className="text-sm text-royal hover:underline">{process.env.NEXT_PUBLIC_SUPPORT_EMAIL || 'support@chap.co.ke'}</a>
