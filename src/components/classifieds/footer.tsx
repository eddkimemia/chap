...
const socialDefaults = {
  facebook: 'https://facebook.com/chapke',
  twitter: 'https://twitter.com/chapke',
  instagram: 'https://instagram.com/chapke',
  youtube: 'https://youtube.com/@chapke',
}

export function Footer() {
  const { categories, siteSettings } = useAppStore()
    ...
    <footer className="mt-auto bg-navy text-white relative overflow-hidden">
      <div className="container mx-auto px-4 lg:px-8 py-16 relative">
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li><Link href="/dashboard/plans" className="text-sm text-white/50 hover:text-white transition-colors">Premium Plans</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-white/10">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-center">
            <div className="flex gap-3">
              <a href={siteSettings.facebook_url || socialDefaults.facebook} target="_blank" rel="noopener noreferrer" className="h-10 w-10 rounded-xl flex items-center justify-center transition-all" style={{ backgroundColor: '#1877F2' }} aria-label="Facebook">
              ...
              <a href={siteSettings.twitter_url || socialDefaults.twitter} target="_blank" rel="noopener noreferrer" className="h-10 w-10 rounded-xl flex items-center justify-center transition-all" style={{ backgroundColor: '#000' }} aria-label="Twitter">
              ...
              <a href={siteSettings.instagram_url || socialDefaults.instagram} target="_blank" rel="noopener noreferrer" className="h-10 w-10 rounded-xl flex items-center justify-center transition-all" style={{ background: 'linear-gradient(45deg, #f09433, #e6683c, #dc2743, #cc2366, #bc1888)' }} aria-label="Instagram">
              ...
              <a href={siteSettings.youtube_url || socialDefaults.youtube} target="_blank" rel="noopener noreferrer" className="h-10 w-10 rounded-xl flex items-center justify-center transition-all" style={{ backgroundColor: '#FF0000' }} aria-label="YouTube">
        ...
        <div className="mt-6 pt-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-white/30">
          <p>{siteSettings.copyright_text || `\u00A9 ${year} ${siteSettings.site_name || 'ChapKE'}. Kenya\u2019s #1 Digital Marketplace. All rights reserved.`}</p>
        </div>
      </div>
    </footer>
  )
